...
return Sleef_fabs(Sleef_sqrt_u05(Sleef_pow_u10(x, 2.0) + Sleef_pow_u10(y, 2.0) + Sleef_pow_u10(z, 2.0)));
}
...
double fastatan2(double y,double x){
  ...
  const double a=Sleef_fmin(absx,absy)/Sleef_fmax(absx,absy);             // a = |x|<|y| ? |x|/|y| : |y|/|x|
  const double s=a*a;
  double r;
...
engine->RegisterGlobalFunction("double sinpi(double a)", asFUNCTION(Sleef_sinpi_u05), asCALL_CDECL);
engine->RegisterGlobalFunction("double cospi(double x)", asFUNCTION(Sleef_cospi_u05), asCALL_CDECL);
engine->RegisterGlobalFunction("double tan(double x)", asFUNCTION(Sleef_tan_u10), asCALL_CDECL);
// Power, exponential, and logarithmic functions
engine->RegisterGlobalFunction("double pow(double x, double y)", asFUNCTION(Sleef_pow_u10), asCALL_CDECL);
engine->RegisterGlobalFunction("double log(double x)", asFUNCTION(Sleef_log_u10), asCALL_CDECL);
engine->RegisterGlobalFunction("double log10(double x)", asFUNCTION(Sleef_log10_u10), asCALL_CDECL);
engine->RegisterGlobalFunction("double log2(double x)", asFUNCTION(Sleef_log2_u10), asCALL_CDECL);
engine->RegisterGlobalFunction("double log1p(double x)", asFUNCTION(Sleef_log1p_u10), asCALL_CDECL);
...
engine->RegisterGlobalFunction("double exp10(double x)", asFUNCTION(Sleef_exp10_u10), asCALL_CDECL);
engine->RegisterGlobalFunction("double expm1(double x)", asFUNCTION(Sleef_expm1_u10), asCALL_CDECL);
...
engine->RegisterGlobalFunction("double hypot(double x, double y)", asFUNCTION(Sleef_hypot_u05), asCALL_CDECL);
engine->RegisterGlobalFunction("double hypot(double x, double y, double z)", asFUNCTION(hypot3), asCALL_CDECL);
...
engine->RegisterGlobalFunction("double atan2(double y, double x)", asFUNCTION(Sleef_atan2_u10), asCALL_CDECL);
...
engine->RegisterGlobalFunction("double asinh(double x)", asFUNCTION(Sleef_asinh_u10), asCALL_CDECL);
engine->RegisterGlobalFunction("double acosh(double x)", asFUNCTION(Sleef_acosh_u10), asCALL_CDECL);
engine->RegisterGlobalFunction("double atanh(double x)", asFUNCTION(Sleef_atanh_u10), asCALL_CDECL);
...
engine->RegisterGlobalFunction("double tgamma(double x)", asFUNCTION(Sleef_tgamma_u10), asCALL_CDECL);
engine->RegisterGlobalFunction("double lgamma(double x)", asFUNCTION(Sleef_lgamma_u10), asCALL_CDECL);
...
// Other functions
engine->RegisterGlobalFunction("double fma(double x, double y, double z)", asFUNCTION(Sleef_fma), asCALL_CDECL);
engine->RegisterGlobalFunction("double fmod(double x, double y)", asFUNCTION(Sleef_fmod), asCALL_CDECL);
engine->RegisterGlobalFunction("double remainder(double x, double y)", asFUNCTION(Sleef_remainder), asCALL_CDECL);
engine->RegisterGlobalFunction("double ldexp(double n, int x)", asFUNCTION(Sleef_ldexp), asCALL_CDECL);
engine->RegisterGlobalFunction("double frfrexp(double x)", asFUNCTION(Sleef_frfrexp), asCALL_CDECL);
engine->RegisterGlobalFunction("int expfrexp(double x)", asFUNCTION(Sleef_expfrexp), asCALL_CDECL);
engine->RegisterGlobalFunction("int ilogb(double x, int n)", asFUNCTION(Sleef_ilogb), asCALL_CDECL);
engine->RegisterGlobalFunction("double abs(double x)", asFUNCTION(Sleef_fabs), asCALL_CDECL);
engine->RegisterGlobalFunction("double max(double x, double y)", asFUNCTION(Sleef_fmax), asCALL_CDECL);
engine->RegisterGlobalFunction("double min(double x, double y)", asFUNCTION(Sleef_fmin), asCALL_CDECL);
engine->RegisterGlobalFunction("double fdim(double x, double y)", asFUNCTION(Sleef_fdim), asCALL_CDECL);
engine->RegisterGlobalFunction("double copysign(double x, double y)", asFUNCTION(Sleef_copysign), asCALL_CDECL);
engine->RegisterGlobalFunction("double nextafter(double x, double y)", asFUNCTION(Sleef_nextafter), asCALL_CDECL);
// Fast sin/cos/atan/atan2 approximations, and blend
engine->RegisterGlobalFunction("double blend(double a, double b, double x, double y)", asFUNCTION(blend), asCALL_CDECL);
...
engine->RegisterGlobalFunction("double atan_approx(double x)", asFUNCTION(fastatan), asCALL_CDECL);
engine->RegisterGlobalFunction("double atan2_approx(double y, double x)", asFUNCTION(fastatan2), asCALL_CDECL);
